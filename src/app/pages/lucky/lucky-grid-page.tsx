    ...
    const queryRaffleAwardListHandle = async () => {
        ...
        const prizes = [
            ...
            },
            {
                ...
                y: 2,
                fonts: [{
                    text: data[4].hasAwardUnlock ? data[4].awardTitle : '再抽奖' + data[4].waitUnLockCount + '次解锁',
                    top: '80%',
                    fontSize: '12px',
                    fontWeight: '800'
                }],
                imgs: [{
                    src: data[4].hasAwardUnlock ? "/raffle-award-22.png" : "/raffle-award-22-lock.png",
                    width: "100px",
                    height: "100px",
            ...
            },
            {
                ...
                y: 2,
                fonts: [{
                    text: data[5].hasAwardUnlock ? data[5].awardTitle : '再抽奖' + data[5].waitUnLockCount + '次解锁',
                    top: '80%',
                    fontSize: '12px',
                    fontWeight: '800'
                }],
                imgs: [{
                    src: data[5].hasAwardUnlock ? "/raffle-award-21.png" : "/raffle-award-21-lock.png",
                    width: "100px",
                    height: "100px",
                    activeSrc: "/raffle-award.png"
                }]
            },
            {
                ...
                y: 2,
                fonts: [{
                    text: data[6].hasAwardUnlock ? data[6].awardTitle : '再抽奖' + data[6].waitUnLockCount + '次解锁',
                    top: '80%',
                    fontSize: '12px',
                    fontWeight: '800'
                }],
                imgs: [{
                    src: data[6].hasAwardUnlock ? "/raffle-award-20.png" : "/raffle-award-20-lock.png",
                    width: "100px",
                    height: "100px",
                    activeSrc: "/raffle-award.png"
                }]
